            ...
            <flux:modal name="create-device-model" class="md:w-96">
                <div class="space-y-6">
                    ...
                    <form wire:submit="createDeviceModel">
                        ...
                        <div class="mb-4">
                            <flux:input label="Label" wire:model="label" id="label" class="block mt-1 w-full" type="text"
                                        name="label"/>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Width" wire:model="width" id="width" class="block mt-1 w-full" type="number"
                                        name="width"/>
                            <flux:input label="Height" wire:model="height" id="height" class="block mt-1 w-full" type="number"
                                        name="height"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Colors" wire:model="colors" id="colors" class="block mt-1 w-full" type="number"
                                        name="colors"/>
                            <flux:input label="Bit Depth" wire:model="bit_depth" id="bit_depth" class="block mt-1 w-full" type="number"
                                        name="bit_depth"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Scale Factor" wire:model="scale_factor" id="scale_factor" class="block mt-1 w-full" type="number"
                                        name="scale_factor" step="0.1"/>
                            <flux:input label="Rotation" wire:model="rotation" id="rotation" class="block mt-1 w-full" type="number"
                                        name="rotation"/>
                        </div>

                        <div class="mb-4">
                            <flux:input label="MIME Type" wire:model="mime_type" id="mime_type" class="block mt-1 w-full" type="text"
                                        name="mime_type"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Offset X" wire:model="offset_x" id="offset_x" class="block mt-1 w-full" type="number"
                                        name="offset_x"/>
                            <flux:input label="Offset Y" wire:model="offset_y" id="offset_y" class="block mt-1 w-full" type="number"
                                        name="offset_y"/>
                        </div>

                        <div class="mb-4">
                            <flux:input label="Published At" wire:model="published_at" id="published_at" class="block mt-1 w-full" type="datetime-local"
                                        name="published_at"/>
                        </div>
            ...
            @foreach ($deviceModels as $deviceModel)
                <flux:modal name="edit-device-model-{{ $deviceModel->id }}" class="md:w-96">
                    <div class="space-y-6">
                        ...
                        <div class="mb-4">
                            <flux:input label="Name" wire:model="name" id="edit_name" class="block mt-1 w-full" type="text"
                                        name="edit_name"/>
                        </div>

                        <div class="mb-4">
                            <flux:input label="Label" wire:model="label" id="edit_label" class="block mt-1 w-full" type="text"
                                        name="edit_label"/>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Width" wire:model="width" id="edit_width" class="block mt-1 w-full" type="number"
                                        name="edit_width"/>
                            <flux:input label="Height" wire:model="height" id="edit_height" class="block mt-1 w-full" type="number"
                                        name="edit_height"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Colors" wire:model="colors" id="edit_colors" class="block mt-1 w-full" type="number"
                                        name="edit_colors"/>
                            <flux:input label="Bit Depth" wire:model="bit_depth" id="edit_bit_depth" class="block mt-1 w-full" type="number"
                                        name="edit_bit_depth"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Scale Factor" wire:model="scale_factor" id="edit_scale_factor" class="block mt-1 w-full" type="number"
                                        name="edit_scale_factor" step="0.1"/>
                            <flux:input label="Rotation" wire:model="rotation" id="edit_rotation" class="block mt-1 w-full" type="number"
                                        name="edit_rotation"/>
                        </div>

                        <div class="mb-4">
                            <flux:input label="MIME Type" wire:model="mime_type" id="edit_mime_type" class="block mt-1 w-full" type="text"
                                        name="edit_mime_type"/>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <flux:input label="Offset X" wire:model="offset_x" id="edit_offset_x" class="block mt-1 w-full" type="number"
                                        name="edit_offset_x"/>
                            <flux:input label="Offset Y" wire:model="offset_y" id="edit_offset_y" class="block mt-1 w-full" type="number"
                                        name="edit_offset_y"/>
                        </div>

                        <div class="mb-4">
                            <flux:input label="Published At" wire:model="published_at" id="edit_published_at" class="block mt-1 w-full" type="datetime-local"
                                        name="edit_published_at"/>
                        </div>
                            ...
                            <div class="flex items-center gap-4">
                                <flux:button.group>
                                    <flux:modal.trigger name="edit-device-model-{{ $deviceModel->id }}">
                                        <flux:button wire:click="editDeviceModel({{ $deviceModel->id }})" icon="pencil" iconVariant="outline">
                                        </flux:button>
                                    </flux:modal.trigger>
                                    <flux:button wire:click="deleteDeviceModel({{ $deviceModel->id }})" icon="trash" iconVariant="outline">
                                    </flux:button>
                                </flux:button.group>
                            </div>
                        </td>
